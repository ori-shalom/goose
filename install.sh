...
if [ $# -eq 0 ]; then
	goose_uri="https://github.com/piiano/goose/releases/latest/download/goose_${os}_${arch}"
else
	goose_uri="https://github.com/piiano/goose/releases/download/${1}/goose_${os}_${arch}"
fi
